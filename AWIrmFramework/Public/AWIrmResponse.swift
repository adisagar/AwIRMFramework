...
public class AWIrmResponse: NSObject {
    ...
    public var originalFileExtn : String = ""
    
    public var irmDataProvider : AWIrmDataProviderProtocol
    
    public var userPolicy : AWIrmUserPolicy
    
    
    public init(fileExtn:String, dataProvider:AWIrmDataProviderProtocol, policy:AWIrmUserPolicy) {
